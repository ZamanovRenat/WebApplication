    ...
    <div class="d-flex flex-row bd-highlight mb-3">
        <div class="p-2 w-50 bd-highlight">
            ...
            <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" v-model="EmployeePatronymic">
            </div>
            <div class="input-group mb-3">
            ...
            <div class="input-group mb-3">
                <span class="input-group-text">Дата устройства</span>
...
methods:{
    ...
    addClick(){
        this.modalTitle="Добавить сотдрудника";
        this.EmployeeId=0;
    ...
    editClick(emp){
        ...
        this.EmployeeSurName=emp.EmployeeSurName;
        this.EmployeeFirstName=emp.EmployeeFirstName;
        this.EmployeePatronymic=emp.EmployeePatronymic;
    ...
    createClick(){
        axios.post(variables.API_URL+"employee",{
            ...
            EmployeePatronymic:this.EmployeePatronymic,
